...
let DogController = class DogController {
    ...
    async getWithId(id, dogPost) {
        return this.dogService.getByid(id);
    }
    async update(id, dogPost) {
...
], DogController.prototype, "insert", null);
__decorate([
    (0, common_1.Get)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], DogController.prototype, "getEm", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", Promise)
], DogController.prototype, "getWithId", null);
__decorate([
    (0, common_1.Put)(':id'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
